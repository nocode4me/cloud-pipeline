...
def create_nic(instance_name, run_id):
    ...
    if allowed_networks and len(allowed_networks) > 0:
        ...
        subnet = subnet_id if "/" not in subnet_id else get_subnet_name_from_id(subnet_id)
...
def get_subnet_name_from_id(subnet_id):
    ...
    if len(subnet_params) == 11 and subnet_params[4] == "resourceGroups" and subnet_params[9] == "subnets":
